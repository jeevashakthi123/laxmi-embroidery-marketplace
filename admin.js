...
const CATEGORY_SEED = [
  ...
  { id: 'aari-cut', name: 'Aari Cut', count: 0 },
  { id: 'all-over', name: 'All Over', count: 0 },
  { id: 'animals', name: 'Animals', count: 0 },
  { id: 'baby-shower', name: 'Baby Shower', count: 0 },
  { id: 'beads', name: 'Beads', count: 0 },
  { id: 'birds', name: 'Birds', count: 0 },
  { id: 'boat', name: 'Boat', count: 0 },
  { id: 'bridal-br', name: 'Bridal BR', count: 0 },
  { id: 'bunch', name: 'Bunch', count: 0 },
  { id: 'butterfly', name: 'Butterfly', count: 0 },
  { id: 'checks', name: 'Checks', count: 0 },
  { id: 'christmas', name: 'Christmas', count: 0 },
  { id: 'coat-neck', name: 'Coat Neck', count: 0 },
  { id: 'colour-neck', name: 'Colour Neck', count: 0 },
  { id: 'coming-soon', name: 'Coming Soon', count: 0 },
  { id: 'cow', name: 'Cow', count: 0 },
  { id: 'cross-stitch', name: 'Cross Stitch', count: 0 },
  { id: 'cut-work', name: 'Cut Work', count: 0 },
  { id: 'deer', name: 'Deer', count: 0 },
  { id: 'doll', name: 'Doll', count: 0 },
  { id: 'double-neck', name: 'Double Neck', count: 0 },
  { id: 'double-shoulder', name: 'Double Shoulder', count: 0 },
  { id: 'dress', name: 'Dress', count: 0 },
  { id: 'elephant', name: 'Elephant', count: 0 },
  { id: 'fish', name: 'Fish', count: 0 },
  { id: 'flowers', name: 'Flowers', count: 0 },
  { id: 'frames', name: 'Frames', count: 0 },
  { id: 'fruit', name: 'Fruit', count: 0 },
  { id: 'goat', name: 'Goat', count: 0 },
  { id: 'hand-cut-line', name: 'Hand Cut Line', count: 0 },
  { id: 'heart', name: 'Heart', count: 0 },
  { id: 'home', name: 'Home', count: 0 },
  { id: 'house', name: 'House', count: 0 },
  { id: 'jewellery', name: 'Jewellery', count: 0 },
  { id: 'kutch', name: 'Kutch', count: 0 },
  { id: 'leaf', name: 'Leaf', count: 0 },
  { id: 'lotus', name: 'Lotus', count: 0 },
  { id: 'madhubala', name: 'Madhubala', count: 0 },
  { id: 'mango', name: 'Mango', count: 0 },
  { id: 'mickey', name: 'Mickey', count: 0 },
  { id: 'mirror', name: 'Mirror', count: 0 },
  { id: 'net-cloth-work', name: 'Net Cloth Work', count: 0 },
  { id: 'outside-neck-off', name: 'Outside Neck Off', count: 0 },
  { id: 'parrot', name: 'Parrot', count: 0 },
  { id: 'peacock', name: 'Peacock', count: 0 },
  { id: 'photo-design', name: 'Photo Design', count: 0 },
  { id: 'pillow-cover', name: 'Pillow Cover', count: 0 },
  { id: 'purse-cut', name: 'Purse Cut', count: 0 },
  { id: 'rangoli', name: 'Rangoli', count: 0 },
  { id: 'rose', name: 'Rose', count: 0 },
  { id: 'saree-borders', name: 'Saree Borders', count: 0 },
  { id: 'simple', name: 'Simple', count: 0 },
  { id: 'square', name: 'Square', count: 0 },
  { id: 'stone-work', name: 'Stone Work', count: 0 },
  { id: 'temple', name: 'Temple', count: 0 },
  { id: 'toy-hand', name: 'Toy Hand', count: 0 },
  { id: 'tree', name: 'Tree', count: 0 },
  { id: 'umbrella', name: 'Umbrella', count: 0 },
  { id: 'v-neck', name: 'V Neck', count: 0 }
];

const CATEGORIES = LS.get(K.CATS, null) || CATEGORY_SEED;
if (!LS.get(K.CATS, null)) LS.set(K.CATS, CATEGORIES);
  ...
  <div class="grid-main-side" style="grid-template-columns:1.9fr 1fr">
    <div class="stack">
      ...
      <div class="card"><h3>Technical</h3>
        <div class="grid4">
          <div class="field"><label>Model Number (Code) <b>*</b></label><input id="fCodeTech" value="${esc(p.code)}" placeholder="e.g. LE025" ${edit ? 'readonly style="opacity:.5"' : ''}></div>
          <div class="field"><label>Design Name <b>*</b></label><input id="fNameTech" value="${esc(p.name)}" placeholder="e.g. Royal Floral Neckline"></div>
